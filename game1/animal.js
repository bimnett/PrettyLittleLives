class Animal {
  ...
  const animals = [
    new Animal("Dog", "./sounds/1-dog.mp3", "./images/640x480/1-dog-640x480.png"),
    new Animal("Cat", "./sounds/2-dog.mp3", "./images/640x480/2-cat-640x480.png"),
    new Animal("Bird", "./sounds3-bird.mp3", "./images/640x480/3-bird-640x480.png"),
    new Animal("Lion", "./sounds/4-lion.mp3", "./images/640x480/4-lion-640x480.png"),
    new Animal("Horse", "./sounds/5-horse.mp3", "./images/640x480/5-horse-640x480.png"),
